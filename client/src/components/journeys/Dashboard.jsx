...
const Dashboard = () => {
  ...
  const [showJoin, setJoin] = useState("");
  ...
  useEffect(() => {
    async function fetchJourney() {
      ...
      setJoin(journeyDetails.users.includes(currentUserId));
  ...
  if (loading) {
    ...
    return (
      <div>
        ...
        >
          <Container maxWidth="" id="journeyDash">
            <br />
            <Grid container direction="row" spacing={5}>
              ...
              >
                ...
                >
                  ...
                  {!allowEdit && requestStatus === "" && !showJoin && (
                    <Button
                      onClick={joinJourney}
                      color="primary"
                      variant="outlined"
